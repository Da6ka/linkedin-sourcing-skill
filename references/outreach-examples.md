...
They're expanding into [region/segment] and looking for a [Title] who's done this before — and
...
The role is [Title], with strategic influence from the start — your LinkedIn profile is what put
...
and your LinkedIn profile is exactly the background it calls for.
...
maintains an existing one — your LinkedIn profile reads like someone ready for exactly that.
...
4. **Length.** 80–120 words, and no more — long enough to be specific, short enough to respect
   their time. The examples above are skeletons; once the placeholders are filled with real
   detail, a finished message lands in that range.
